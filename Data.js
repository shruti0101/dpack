export const categories = [
  ...
  excerpt: [
    {
      type: "p",
      text: "Dunnage Bags are inflatable cargo securing solutions used to fill gaps between goods during transportation. They help stabilize loads, prevent movement, and protect products from damage in shipping containers, trucks, and railcars.",
    },
  ],

  description: [
    { type: "h2", text: "Dunnage Bags" },

    {
      type: "p",
      text: "Dunnage Bags are essential cargo protection solutions used in logistics and transportation industries. These inflatable bags are placed between cargo to fill voids and secure loads, preventing movement, vibration, and impact damage during transit. They provide a reliable and cost-effective method for stabilizing shipments in containers, trucks, railcars, and ships.",
    },

    { type: "h2", text: "Key Features – Dunnage Bags" },

    {
      type: "ul",
      items: [
        "High-strength material for superior load stability",
        "Prevents cargo shifting during transportation",
        "Quick inflation and easy installation",
        "Available in multiple sizes and pressure ratings",
        "Durable, reusable, and cost-effective cargo protection",
      ],
    },

    {
      type: "h2",
      text: "Applications – Dunnage Bags are widely used in:",
    },

    {
      ...
      items: [
        ...
        "Truck and railcar transportation",
        "Automotive and industrial shipments",
        "Food and agricultural product transport",
        "FMCG and retail goods logistics",
      ],
    },
  ],

  pdfs: {
    sds: "/products/dunnage-bag-sds.pdf",
    tds: "/products/dunnage-bag-tds.pdf",
  },
},
